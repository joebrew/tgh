...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={The investment case for malaria elimination},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{The investment case for malaria elimination}
    \author[Centro de Investigação em Saude de Manhiça]{Laia Cirera\corref{c1}}
   \ead{laia@economicsofmalaria.com} 
