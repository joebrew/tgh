...
The primary objective is to quantify the direct economic costs and benefits of malaria interventions carried out by private firms, using the case of Maragra Açucar CA.

## Specific objectives

In addition, and in complentarity to the primary objective, secondary objectives include:  

- The quantification of worker absenteeism over time, and in association with malaria control activities.
- The quantification of worker _productivity_ over time, and in association with malaria control activities.
...
In the spring and summer of 2016, under the auspices of the MALTEM (Mozambican Alliance Towards the Elimination of Malaria), and in cooperation with the CISM (Centro de Investigaçao em Saude de Manhiça) and Maragra Açucar CA, data will be collected pertaining to:  
...
- Worker illness data (from on-site clinics).
