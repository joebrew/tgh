---
title: "Quantifying the economic impact of malaria control interventions in Maragra, Mozambique: a win-win for private industry and public health"
author: 
  - Joe Brew
  - Elisa Sicuri  
...
temp <- 
  data.frame(id = 1:5,
             ...
             `contract type` = sample(letters, 5),
             `years of education` = sample(1:10, 5),
